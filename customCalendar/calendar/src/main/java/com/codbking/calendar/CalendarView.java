...
public class CalendarView extends ViewGroup implements CaledarAdapter.OnDataChangedListener {
    ...
    public interface OnItemClickListener {
        void onItemClick(CalendarView parent, View view, int postion, CalendarBean bean);
    }
    ...
    private void setItem() {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            View chidView = adapter.getView(view, this, selectPostion, i, bean);
    ...
    public void setItemClick(final View view, final int potsion, final CalendarBean bean) {
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (adapter != null) {
                    isEnable = adapter.isEnabled(potsion, bean);
                }
                if (isEnable) {
                    if (selectPostion != -1) {
                    ...
                    if (onItemClickListener != null) {
                        onItemClickListener.onItemClick(CalendarView.this, view, potsion, bean);
                    }
                }
            }
        });
